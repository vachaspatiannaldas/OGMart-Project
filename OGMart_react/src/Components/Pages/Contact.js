						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li><Link to="mailto:ogmart@gmail.com">ogmart@gmail.com</Link></li>
										<li><Link to="mailto:annaldasvachaspati@gmail.com">annaldasvachaspati@gmail.com</Link></li>
									</ul>
								</div>
								<div class="single-info">
									...
									<ul>
										<li>102 B 16 Bhavani Peth, D.A.V. College Road, Solapur, Maharashtra.</li>
									</ul>
								</div>
							</div>
						</div>
