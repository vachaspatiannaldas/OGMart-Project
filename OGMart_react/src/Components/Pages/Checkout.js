			...
			<div class="row">
				<div class="">
				  ...
				  totalCartPrice += row.price_sale * row.pqty - dis
										  return(
							<tr>
								<td class="image" data-title="Product"><img  src={`http://localhost:8000/product_upload/${row.img}`} alt="#"  style={{width:"180px",height:"50px"}}  /></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><Link to="#">{row.pname}</Link></p>
									<p class="product-des">Maboriosam in a tonto nesciung eget  distingy magndapibus.</p>
								</td>
								<td class="price" data-title="Quantity"><span>{row.pqty}</span></td>
								
								<td class="total-amount" data-title="Price"><span>{row.price_sale}</span></td>
						...
						<div class="order-details col-md-7" style={{float:"right",marginTop:"-40px"}}>
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										...
										<li>(+) Shipping<span><i class="fa fa-rupee"></i>0.00</span></li>
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<button type="button" class="btn"onClick={(e)=>handleSubmit(e,'cod')}>Cash On Delivery</button>
